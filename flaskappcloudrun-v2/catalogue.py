...
def video_page(video):
    ...
    url = 'http://34.142.107.226/myflix/videos?filter={"video.file":"'+video+'"}'
    headers = {}
    payload = json.dumps({ })
    ...
    for index in jResp:
       ...
       for key in index:
           ...
           if (key !="_id"):
              ...
              html=html+'<img src="delete this sentence and replace with googlebucket link'+thumb+'" width="320" height="240">'
              html=html+"</a>"        
              print("=======================")
